        ...
        <div className="lg:col-span-1 space-y-6">
           ...
           <div className="glass-panel p-6 rounded-2xl border border-slate-800 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col items-center mt-4">
                 ...
                 <p className="text-sm text-cyan-400 font-medium mb-1">Administrator</p>
                 <p className="text-xs text-slate-500">john.doe@neurocore.edu</p>
                 
                 <div className="mt-6 w-full space-y-2">
                    <button className="w-full py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 text-sm font-medium rounded-lg transition-colors border border-slate-700">
                       编辑个人资料
                    </button>
                    <button 
                       onClick={onLogout}
